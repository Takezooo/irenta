...
const LandingPage = () => {
    ...
    const cards = [
        { title: "Live Good Dormitory", location: "Ermita, Manila", price: "₱2,000 - ₱8,000" },
        { title: "Live Good Dormitory", location: "Ermita, Manila", price: "₱2,000 - ₱8,000" },
        { title: "Live Good Dormitory", location: "Ermita, Manila", price: "₱2,000 - ₱8,000" },
        { title: "Live Good Dormitory", location: "Ermita, Manila", price: "₱2,000 - ₱8,000" },
        { title: "Live Good Dormitory", location: "Ermita, Manila", price: "₱2,000 - ₱8,000" },
    ...
    return (
        <div>
            ...
            <div className="mx-auto mt-36 flex align-center flex-col p-5 rounded-xl w-[90%] from-blue-950 bg-gradient-to-r to-gray-800 overflow-hidden">
                ...
                <p className="text-m text-white mb-[20px]">Please choose an option to continue.</p>
                ...
                <div className="flex flex-row gap-4">
                    ...
                    <Link to="/register">
                        <button className="w-[100%] px-[24px] py-[10px] rounded-md bg-gray-400 bg-opacity-30 text-white hover:bg-gray-400 transition ease-in duration-300">Register</button>
                    </Link>
                </div>
            </div>
            ...
            <div className="mx-auto flex align-center flex-col rounded-xl mt-16 w-[90%]">
                ...
                <div className="relative">
                    ...
                    {cards.map((card, index) => (
                        ...
                        >
                        <div className="h-40 bg-gray-200 rounded-md mb-4"></div> {/* Placeholder for image */}
                ...
                <div className="w-[40%]">
                    ...
                    <div className="bg-gray-300 p-6 mt-2 rounded-xl text-black text-wrap">
                        <p className="mt-2 text-sm">
                            This is a placeholder description for the additional div. It includes a brief overview and is styled for aesthetic alignment.
                            This is a placeholder description for the additional div. It includes a brief overview and is styled for aesthetic alignment.
                            This is a placeholder description for the additional div. It includes a brief overview and is styled for aesthetic alignment.
                            This is a placeholder description for the additional div. It includes a brief overview and is styled for aesthetic alignment.
                            This is a placeholder description for the additional div. It includes a brief overview and is styled for aesthetic alignment.
                        </p>
                        <a href="#" className="mt-4 inline-block text-black underline">See more</a>
                    </div>
                </div>
            </div>
            <Footer />
